...
<body class="bg-light">
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        ...
        <table class="table table-bordered">
            ...
            if(isset($_GET['cari'])){
                $cari = $_GET['cari'];
                $query = mysqli_query($koneksi,"SELECT * FROM arsip_statis_bpppkb WHERE judul_berkas or uraian_item like '%".$cari."%'");				
            }else{
                $query = mysqli_query($koneksi,"SELECT * FROM arsip_statis_bpppkb");		
            }
