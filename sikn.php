            ...
            <div class="col">
                <div class="card h-100 text-center">
                    <div class="card-body">
                        ...
                        <h5 class="card-title">daftar arsip sudah input</h5>
                        <a href="sudah_input.php" class="btn btn-primary mt-3">Masuk</a>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card h-100 text-center">
                    <div class="card-body">
                        <i class="bx bx-conversation fs-1"></i>
                        <h5 class="card-title">daftar arsip potensi input</h5>
