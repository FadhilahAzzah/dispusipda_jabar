...
if (isset($_GET['tanggal_awal']) && isset($_GET['tanggal_akhir'])) {
    ...
    $query = "SELECT * FROM tb_galericovid WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'";
...
<div class="container mt-4">
        ...
        <tbody>
            <?php while ($row = mysqli_fetch_assoc($result)): ?>
                <tr>
                    ...
                    <td>
                        <a href="update_galericovid.php?id_pengguna=<?php echo $row['id_pengguna']; ?>" type="button" class="btn btn-success btn-sm">Edit</a>                                                  
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">                          
                                        <a href="delete_galeri_covid.php?id_pengguna=<?php echo $row['id_pengguna']; ?>" class="btn btn-danger">Hapus</a>
    ...
    <div class="no-print">
        ...
        <a href="daftar_galeri_covid19.php" class="btn btn-secondary">Kembali</a>
    </div>
</div>
