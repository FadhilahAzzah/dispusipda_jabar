...
if (isset($_GET['tanggal_awal']) && isset($_GET['tanggal_akhir'])) {
    ...
    $query = "SELECT * FROM tabel_form WHERE tanggal_kunjungan BETWEEN '$tanggal_awal' AND '$tanggal_akhir'";
...
if (isset($_GET['export']) && $_GET['export'] === 'word') {
    ...
    echo "<thead>";
    echo "<tr>";
    echo "<th>nama_pengunjung</th>";
    echo "<th>instansi_sekolah</th>"; 
    echo "<th>tanggal_kunjungan</th>";
    echo "<th>jumlah_pengunjung</th>";
    echo "<th>alamat</th>";
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<td>" . htmlspecialchars($row['instansi_sekolah']) . "</td>";
...
<div class="container mt-4">
        ...
        <tbody>
            <?php while ($row = mysqli_fetch_assoc($result)): ?>
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($row['instansi_sekolah']); ?></td>
                    ...
                    <td>
                        <a href="edit_bukutamu.php?id_pengguna=<?php echo $row['id_pengguna']; ?>" type="button" class="btn btn-success btn-sm">Edit</a>                                                  
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">                          
                                        <a href="delete_bukutamu.php?id_pengguna=<?php echo $row['id_pengguna']; ?>" class="btn btn-danger">Hapus</a>
    ...
    <div class="no-print">
        ...
        <a href="daftar_buku_tamu.php" class="btn btn-secondary">Kembali</a>
    </div>
</div>
