...
if(isset($_POST["submit"])) {
    ...
    $jumlah_pengunjung = $_POST["jumlah_pengunjung"];
        $query = "INSERT INTO kunjungan_kearsipan VALUES ('','$tanggal', '$lembaga_instansi','$nomor', '$email', '$tujuan_kunjungan', '$jumlah_pengunjung')";
...
<body>
    <section class="container">
        <div class="navbar">
        <header>Kunjungan Wisata Kearsipan</header>
        </div>
        <form action="kunjungan_kearsipan.php" method="post" class="form">
            <div class="input-box">
